...
export const translations = {
  es: {
    ...
    browseCompetitions: "Explorar competiciones",
    featured: "Destacados",
    ...
    fallbackData: "Fallback demo explícito",
    quotaFallbackData: "Fallback demo explícito",
    apiEmptyData: "API-Football sin datos",
    apiErrorData: "Error de API-Football",
    language: "Idioma",
    theme: "Tema",
    dark: "Oscuro",
    light: "Claro",
    ...
    against: "contra",
    noMatchesDateTitle: "Sin actividad para esta fecha",
    noMatchesDateDescription: "No encontramos partidos programados para el día seleccionado.",
    noMatchesDateHelper: "Probá con otra fecha o revisá las próximas jornadas.",
    apiEmptyTitle: "Sin actividad para esta fecha",
    apiEmptyDescription: "No encontramos partidos programados para el día seleccionado.",
    apiEmptyHelper: "Probá con otra fecha o revisá las próximas jornadas.",
    ...
    lineupsUnavailable: "Las alineaciones todavía no están disponibles.",
    statisticsUnavailable: "Las estadísticas todavía no están disponibles.",
    eventsUnavailable: "Los eventos todavía no están disponibles.",
    standingsUnavailable: "La clasificación todavía no está disponible.",
  ...
  en: {
    ...
    fallbackData: "Explicit demo fallback",
    quotaFallbackData: "Explicit demo fallback",
    apiEmptyData: "API-Football empty",
    apiErrorData: "API-Football error",
    language: "Language",
    theme: "Theme",
    dark: "Dark",
    light: "Light",
    ...
    against: "against",
    noMatchesDateTitle: "No activity on this date",
    noMatchesDateDescription: "We couldn’t find scheduled matches for the selected day.",
    noMatchesDateHelper: "Try another date or check upcoming fixtures.",
    apiEmptyTitle: "No activity on this date",
    apiEmptyDescription: "We couldn’t find scheduled matches for the selected day.",
    apiEmptyHelper: "Try another date or check upcoming fixtures.",
    ...
    lineupsUnavailable: "Lineups are not available yet.",
    statisticsUnavailable: "Statistics are not available yet.",
    eventsUnavailable: "Events are not available yet.",
  ...
  pt: {
    ...
    browseCompetitions: "Explorar competições",
    featured: "Destaques",
    ...
    fallbackData: "Fallback demo explícito",
    quotaFallbackData: "Fallback demo explícito",
    apiEmptyData: "API-Football sem dados",
    apiErrorData: "Erro da API-Football",
    language: "Idioma",
    theme: "Tema",
    dark: "Escuro",
    light: "Claro",
    ...
    against: "contra",
    noMatchesDateTitle: "Sem atividade nesta data",
    noMatchesDateDescription: "Não encontramos partidas programadas para o dia selecionado.",
    noMatchesDateHelper: "Tente outra data ou veja os próximos jogos.",
    apiEmptyTitle: "Sem atividade nesta data",
    apiEmptyDescription: "Não encontramos partidas programadas para o dia selecionado.",
    apiEmptyHelper: "Tente outra data ou veja os próximos jogos.",
    ...
    lineupsUnavailable: "As escalações ainda não estão disponíveis.",
    statisticsUnavailable: "As estatísticas ainda não estão disponíveis.",
    eventsUnavailable: "Os eventos ainda não estão disponíveis.",
    standingsUnavailable: "A classificação ainda não está disponível.",
    matchSummary: "Resumo do jogo",
    stage: "Fase",
