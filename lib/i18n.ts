...
export const translations = {
  es: {
    ...
    apiEmptyTitle: "API-Football no devolvió partidos reales para esta fecha.",
    apiEmptyDescription: "Probá otra fecha o usá el modo demo para testear la UI.",
  ...
  en: {
    ...
    apiEmptyTitle: "API-Football did not return real matches for this date.",
    apiEmptyDescription: "Try another date or use demo mode for UI testing.",
  ...
  pt: {
    ...
    apiEmptyTitle: "A API-Football não retornou jogos reais para esta data.",
    apiEmptyDescription: "Tente outra data ou use o modo demo para testar a UI.",
